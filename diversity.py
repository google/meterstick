...
class HHI(DiversityBase):
  ...
  def get_sql_and_with_clause(
    ...
    for c in dist_columns:
      ...
      col.set_alias((self.name_tmpl or '{}').format(c.alias_raw))
      columns.add(col)
    return (
...
class TopK(DiversityBase):
  ...
  def get_sql_and_with_clause(
    ...
    for c in dist_columns:
      ...
      top_k_sum_col.set_alias((self.name_tmpl or '{}').format(c.alias_raw))
...
class Nxx(DiversityBase):
  ...
  def get_sql_and_with_clause(
    ...
    for c in dist_columns:
      ...
      nxx_col.set_alias((self.name_tmpl or '{}').format(c.alias_raw))
