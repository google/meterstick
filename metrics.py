...
class Metric(object):
  ...
  def get_fingerprint(self, excluded_attrs=()):
    ...
    Args:
      excluded_attrs: Iterable of attributes to be excluded from fingerprint.
    ...
    if self.children:
      fingerprint['children'] = (
          c.get_fingerprint(excluded_attrs) if isinstance(c, Metric) else c
          for c in self.children
      )
    ...
    for k in self.additional_fingerprint_attrs:
      ...
      if isinstance(val, dict):
        ...
        fingerprint[k] = val.get_fingerprint(excluded_attrs)
      elif val is not None:
        fingerprint[k] = val
    fingerprint = {
        k: v for k, v in fingerprint.items() if k not in excluded_attrs
    }
...
class CompositeMetric(Metric):
  ...
  def get_fingerprint(self, excluded_attrs=()):
    ...
    if isinstance(s, Sum) and isinstance(
      ...
      return Mean(s.var, where=s.where_raw).get_fingerprint(excluded_attrs)
    return super(CompositeMetric, self).get_fingerprint(excluded_attrs)
...
class Ratio(CompositeMetric):
  ...
  def get_fingerprint(self, excluded_attrs=()):
    ...
    return util.get_fingerprint(excluded_attrs)
...
class Dot(SimpleMetric):
  ...
  def get_fingerprint(self, excluded_attrs=()):
    if str(self.var) > str(self.var2):
      ...
      util.var2 = self.var
      return util.get_fingerprint(excluded_attrs)
    return super(Dot, self).get_fingerprint(excluded_attrs)
...
class Correlation(SimpleMetric):
  ...
  def get_fingerprint(self, excluded_attrs=()):
    if str(self.var) > str(self.var2):
      ...
      util.var2 = self.var
      return util.get_fingerprint(excluded_attrs)
    return super(Correlation, self).get_fingerprint(excluded_attrs)
...
class Cov(SimpleMetric):
  ...
  def get_fingerprint(self, excluded_attrs=()):
    if str(self.var) > str(self.var2):
      ...
      util.var2 = self.var
      return util.get_fingerprint(excluded_attrs)
    return super(Cov, self).get_fingerprint(excluded_attrs)
